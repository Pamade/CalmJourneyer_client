...
const PrivacyPolicy: React.FC = () => {
    return (
        <>
            <MetaTags title={"Privacy Policy - CalmJourneyer"} description={"CalmJourneyer Privacy Policy. Learn how we collect, use, and protect your personal data."} canonical={"https://calmjourneyer.com/privacy"} />
