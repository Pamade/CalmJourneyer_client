...
const Onboarding: React.FC = () => {
    ...
    return (
        <>
            <MetaTags title={"Onboarding - CalmJourneyer"} description={"Personalize your meditation experience with CalmJourneyer"} canonical={"https://calmjourneyer.com/onboarding"} />
