...
export default function Login() {
    ...
    return (
        <>
            <MetaTags title={"Sign In / Register - CalmJourneyer"} description={"Sign in or create a CalmJourneyer account to start personalized AI meditation."} canonical={"https://calmjourneyer.com/login"} />
